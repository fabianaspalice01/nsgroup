      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <p style={{ 
            ...
            Crea subito un account per questa azienda. Se lasci vuoto, potrai crearlo in seguito dalla sezione Utenti.
          </p>
        </div>
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <input 
            type="email"
            value={form.emailAccesso}
            onChange={(e) => handleChange('emailAccesso', e.target.value)}
            placeholder="email.accesso@azienda.com"
            disabled={!!azienda}
            style={{
              width: '100%',
              padding: '8px',
              ...
              borderRadius: '6px',
              fontSize: '14px',
              background: azienda ? '#f6f8fc' : 'white'
            }}
          />
          {azienda && (
            <p style={{ fontSize: '12px', color: '#5f6f8c', marginTop: '4px' }}>
              Non puoi modificare l'email in fase di modifica
            </p>
          )}
        </div>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <input 
            type="password"
            value={form.passwordAccesso}
            onChange={(e) => handleChange('passwordAccesso', e.target.value)}
          ...
          {azienda && (
            <p style={{ fontSize: '12px', color: '#5f6f8c', marginTop: '4px' }}>
              Non puoi modificare la password in fase di modifica
            </p>
          )}
        </div>
